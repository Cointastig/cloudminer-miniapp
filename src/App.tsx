  ...
  useEffect(() => {
    const initializeAuth = async () => {
      ...
      try {
        ...
        // We can now proceed to load the user profile. Setting loading to false
        // here allows the profile loader effect to run. Without resetting
        // `loading`, the profile loader early‑returns and the app remains
        // stuck on the initialization screen.
        setLoading(false);
      } catch (err: any) {
